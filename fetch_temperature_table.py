...
tip: If you feel confused about some part of these codes, welcome to contact me, we can add any other city to our project easily by these two .py file. -- Harry Liu
'''
